...
"use strict";function bboxPolygon(o){helpers.validateBBox(o);var e=Number(o[0]),r=Number(o[1]),t=Number(o[2]),l=Number(o[3]);if(6===o.length)throw new Error("@turf/bbox-polygon does not support BBox with 6 positions");var u=[e,r],b=[e,l],n=[t,l],s=[t,r];return helpers.polygon([[u,s,n,b,u]])}var helpers=require("@turf/helpers");module.exports=bboxPolygon,module.exports.default=bboxPolygon;

},{"@turf/helpers":14}],2:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16}],4:[function(require,module,exports){
"use strict";function booleanClockwise(r){if(!r)throw new Error("line is required");var e=r.geometry?r.geometry.type:r.type;if(!Array.isArray(r)&&"LineString"!==e)throw new Error("geometry must be a LineString");for(var o,t,i=invariant.getCoords(r),n=0,a=1;a<i.length;)o=t||i[0],t=i[a],n+=(t[0]-o[0])*(t[1]+o[1]),a++;return n>0}var invariant=require("@turf/invariant");module.exports=booleanClockwise,module.exports.default=booleanClockwise;

},{"@turf/invariant":16}],5:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function buffer(e,r,t){t=t||{};var o=t.units,n=t.steps||64;if(!e)throw new Error("geojson is required");if("object"!=typeof t)throw new Error("options must be an object");if("number"!=typeof n)throw new Error("steps must be an number");if(void 0===r)throw new Error("radius is required");if(n<=0)throw new Error("steps must be greater than 0");n=n||64,o=o||"kilometers";var u=[];switch(e.type){case"GeometryCollection":return meta.geomEach(e,function(e){var t=bufferFeature(e,r,o,n);t&&u.push(t)}),helpers.featureCollection(u);case"FeatureCollection":return meta.featureEach(e,function(e){var t=bufferFeature(e,r,o,n);t&&meta.featureEach(t,function(e){e&&u.push(e)})}),helpers.featureCollection(u)}return bufferFeature(e,r,o,n)}function bufferFeature(e,r,t,o){var n=e.properties||{},u="Feature"===e.type?e.geometry:e;if("GeometryCollection"===u.type){var a=[];return meta.geomEach(e,function(e){var n=bufferFeature(e,r,t,o);n&&a.push(n)}),helpers.featureCollection(a)}var s,i=turfBbox(e),f=i[1]>50&&i[3]>50;s=f?{type:u.type,coordinates:projectCoords(u.coordinates,defineProjection(u))}:projection.toMercator(u);var c=new turfJsts.GeoJSONReader,p=c.read(s),d=helpers.radiansToLength(helpers.lengthToRadians(r,t),"meters"),l=turfJsts.BufferOp.bufferOp(p,d);if(l=(new turfJsts.GeoJSONWriter).write(l),!coordsIsNaN(l.coordinates)){var h;return h=f?{type:l.type,coordinates:unprojectCoords(l.coordinates,defineProjection(u))}:projection.toWgs84(l),h.geometry?h:helpers.feature(h,n)}}function coordsIsNaN(e){return Array.isArray(e[0])?coordsIsNaN(e[0]):isNaN(e[0])}function projectCoords(e,r){return"object"!=typeof e[0]?r(e):e.map(function(e){return projectCoords(e,r)})}function unprojectCoords(e,r){return"object"!=typeof e[0]?r.invert(e):e.map(function(e){return unprojectCoords(e,r)})}function defineProjection(e){var r=center(e).geometry.coordinates.reverse(),t=r.map(function(e){return-e});return d3Geo.geoTransverseMercator().center(r).rotate(t).scale(helpers.earthRadius)}var center=_interopDefault(require("@turf/center")),turfBbox=_interopDefault(require("@turf/bbox")),turfJsts=require("turf-jsts"),projection=require("@turf/projection"),meta=require("@turf/meta"),d3Geo=require("d3-geo"),helpers=require("@turf/helpers");module.exports=buffer,module.exports.default=buffer;
},{"@turf/bbox":2,"@turf/center":6,"@turf/helpers":14,"@turf/meta":19,"@turf/projection":32,"d3-geo":40,"turf-jsts":43}],6:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function center(e,r){if(r=r||{},!helpers.isObject(r))throw new Error("options is invalid");var t=r.properties;if(!e)throw new Error("geojson is required");var o=bbox(e),i=(o[0]+o[2])/2,n=(o[1]+o[3])/2;return helpers.point([i,n],t)}var bbox=_interopDefault(require("@turf/bbox")),helpers=require("@turf/helpers");module.exports=center,module.exports.default=center;

},{"@turf/bbox":2,"@turf/helpers":14}],7:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/meta":19}],8:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function circle(e,r,t){t=t||{};var o=t.steps||64,i=t.properties;if(!e)throw new Error("center is required");if(!r)throw new Error("radius is required");if("object"!=typeof t)throw new Error("options must be an object");if("number"!=typeof o)throw new Error("steps must be a number");o=o||64,i=i||e.properties||{};for(var n=[],s=0;s<o;s++)n.push(destination(e,r,-360*s/o,t).geometry.coordinates);return n.push(n[0]),helpers.polygon([n],i)}var destination=_interopDefault(require("@turf/destination")),helpers=require("@turf/helpers");module.exports=circle,module.exports.default=circle;

},{"@turf/destination":11,"@turf/helpers":14}],9:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16}],10:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16}],12:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16}],13:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function envelope(e){return bboxPolygon(bbox(e))}var bbox=_interopDefault(require("@turf/bbox")),bboxPolygon=_interopDefault(require("@turf/bbox-polygon"));module.exports=envelope,module.exports.default=envelope;

},{"@turf/bbox":2,"@turf/bbox-polygon":1}],14:[function(require,module,exports){
...
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function intersect(e,r){var t=invariant.getGeom(e),n=invariant.getGeom(r);if(cleanCoords(truncate(n,{precision:4})).coordinates[0].length<4)return null;if(cleanCoords(truncate(t,{precision:4})).coordinates[0].length<4)return null;var u=new turfJsts.GeoJSONReader,i=u.read(truncate(t)),a=u.read(truncate(n)),o=turfJsts.OverlayOp.intersection(i,a);if(o.isEmpty())return null;var s=new turfJsts.GeoJSONWriter,l=s.write(o);return helpers.feature(l)}var turfJsts=require("turf-jsts"),truncate=_interopDefault(require("@turf/truncate")),invariant=require("@turf/invariant"),helpers=require("@turf/helpers"),cleanCoords=_interopDefault(require("@turf/clean-coords"));module.exports=intersect,module.exports.default=intersect;

},{"@turf/clean-coords":9,"@turf/helpers":14,"@turf/invariant":16,"@turf/truncate":38,"turf-jsts":43}],16:[function(require,module,exports){
...
},{"@turf/helpers":14}],17:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16,"@turf/line-segment":18,"@turf/meta":19,"geojson-rbush":41}],18:[function(require,module,exports){
...
},{"@turf/helpers":14,"@turf/invariant":16,"@turf/meta":19}],19:[function(require,module,exports){
...
},{"@turf/helpers":14}],20:[function(require,module,exports){
...
},{"@turf/bearing":3,"@turf/destination":11,"@turf/distance":12,"@turf/helpers":14,"@turf/invariant":16,"@turf/line-intersect":17,"@turf/meta":19}],21:[function(require,module,exports){
"use strict";function nearestPointToLine(e,t,r){void 0===r&&(r={});var i=r.units,n=r.properties||{},o=normalize(e);if(!o.features.length)throw new Error("points must contain features");if(!t)throw new Error("line is required");if("LineString"!==invariant_1.getType(t))throw new Error("line must be a LineString");var a=1/0,u=null;return meta_1.featureEach(o,function(e){var r=point_to_line_distance_1.default(e,t,{units:i});r<a&&(a=r,u=e)}),u&&(u.properties=objectAssign({dist:a},u.properties,n)),u}function normalize(e){var t=[];switch(e.geometry?e.geometry.type:e.type){case"GeometryCollection":return meta_1.geomEach(e,function(e){"Point"===e.type&&t.push({type:"Feature",properties:{},geometry:e})}),{type:"FeatureCollection",features:t};case"FeatureCollection":return e.features=e.features.filter(function(e){return"Point"===e.geometry.type}),e;default:throw new Error("points must be a Point Collection")}}Object.defineProperty(exports,"__esModule",{value:!0});var invariant_1=require("@turf/invariant"),point_to_line_distance_1=require("@turf/point-to-line-distance"),meta_1=require("@turf/meta"),objectAssign=require("object-assign");exports.default=nearestPointToLine;

},{"@turf/invariant":23,"@turf/meta":24,"@turf/point-to-line-distance":26,"object-assign":42}],22:[function(require,module,exports){
...
},{"@turf/helpers":22}],24:[function(require,module,exports){
...
},{"@turf/clone":10,"@turf/distance":12,"@turf/meta":19}],26:[function(require,module,exports){
...
},{"@turf/distance":27,"@turf/helpers":28,"@turf/invariant":29,"@turf/meta":30,"@turf/rhumb-distance":31}],27:[function(require,module,exports){
...
},{"@turf/helpers":28,"dup":23}],30:[function(require,module,exports){
arguments[4][24][0].apply(exports,arguments)
},{"@turf/helpers":28,"dup":24}],31:[function(require,module,exports){
...
},{"@turf/helpers":28,"@turf/invariant":29}],32:[function(require,module,exports){
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function toMercator(r,t){return convert(r,"mercator",t)}function toWgs84(r,t){return convert(r,"wgs84",t)}function convert(r,t,e){if(e=e||{},!helpers.isObject(e))throw new Error("options is invalid");var o=e.mutate;if(!r)throw new Error("geojson is required");return Array.isArray(r)&&helpers.isNumber(r[0])?r="mercator"===t?convertToMercator(r):convertToWgs84(r):(!0!==o&&(r=clone(r)),meta.coordEach(r,function(r){var e="mercator"===t?convertToMercator(r):convertToWgs84(r);r[0]=e[0],r[1]=e[1]})),r}function convertToMercator(r){var t=Math.PI/180,e=6378137,o=20037508.342789244,n=Math.abs(r[0])<=180?r[0]:r[0]-360*sign(r[0]),a=[e*n*t,e*Math.log(Math.tan(.25*Math.PI+.5*r[1]*t))];return a[0]>o&&(a[0]=o),a[0]<-o&&(a[0]=-o),a[1]>o&&(a[1]=o),a[1]<-o&&(a[1]=-o),a}function convertToWgs84(r){var t=180/Math.PI,e=6378137;return[r[0]*t/e,(.5*Math.PI-2*Math.atan(Math.exp(-r[1]/e)))*t]}function sign(r){return r<0?-1:r>0?1:0}Object.defineProperty(exports,"__esModule",{value:!0});var meta=require("@turf/meta"),helpers=require("@turf/helpers"),clone=_interopDefault(require("@turf/clone"));exports.toMercator=toMercator,exports.toWgs84=toWgs84;

},{"@turf/clone":10,"@turf/helpers":14,"@turf/meta":19}],33:[function(require,module,exports){
"use strict";function _interopDefault(e){return e&&"object"==typeof e&&"default"in e?e.default:e}function rewind(e,r){if(r=r||{},!helpers.isObject(r))throw new Error("options is invalid");var t=r.reverse||!1,n=r.mutate||!1;if(!e)throw new Error("<geojson> is required");if("boolean"!=typeof t)throw new Error("<reverse> must be a boolean");if("boolean"!=typeof n)throw new Error("<mutate> must be a boolean");!1===n&&(e=clone(e));var o=[];switch(e.type){case"GeometryCollection":return meta.geomEach(e,function(e){rewindFeature(e,t)}),e;case"FeatureCollection":return meta.featureEach(e,function(e){meta.featureEach(rewindFeature(e,t),function(e){o.push(e)})}),helpers.featureCollection(o)}return rewindFeature(e,t)}function rewindFeature(e,r){switch("Feature"===e.type?e.geometry.type:e.type){case"GeometryCollection":return meta.geomEach(e,function(e){rewindFeature(e,r)}),e;case"LineString":return rewindLineString(invariant.getCoords(e),r),e;case"Polygon":return rewindPolygon(invariant.getCoords(e),r),e;case"MultiLineString":return invariant.getCoords(e).forEach(function(e){rewindLineString(e,r)}),e;case"MultiPolygon":return invariant.getCoords(e).forEach(function(e){rewindPolygon(e,r)}),e;case"Point":case"MultiPoint":return e}}function rewindLineString(e,r){booleanClockwise(e)===r&&e.reverse()}function rewindPolygon(e,r){booleanClockwise(e[0])!==r&&e[0].reverse();for(var t=1;t<e.length;t++)booleanClockwise(e[t])===r&&e[t].reverse()}var clone=_interopDefault(require("@turf/clone")),booleanClockwise=_interopDefault(require("@turf/boolean-clockwise")),meta=require("@turf/meta"),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=rewind,module.exports.default=rewind;

},{"@turf/boolean-clockwise":4,"@turf/clone":10,"@turf/helpers":14,"@turf/invariant":16,"@turf/meta":19}],34:[function(require,module,exports){
"use strict";function rhumbBearing(r,e,a){if(a=a||{},!helpers.isObject(a))throw new Error("options is invalid");var t=a.final;if(!r)throw new Error("start point is required");if(!e)throw new Error("end point is required");var i;return i=t?calculateRhumbBearing(invariant.getCoord(e),invariant.getCoord(r)):calculateRhumbBearing(invariant.getCoord(r),invariant.getCoord(e)),i>180?-(360-i):i}function calculateRhumbBearing(r,e){var a=helpers.degreesToRadians(r[1]),t=helpers.degreesToRadians(e[1]),i=helpers.degreesToRadians(e[0]-r[0]);i>Math.PI&&(i-=2*Math.PI),i<-Math.PI&&(i+=2*Math.PI);var n=Math.log(Math.tan(t/2+Math.PI/4)/Math.tan(a/2+Math.PI/4)),o=Math.atan2(i,n);return(helpers.radiansToDegrees(o)+360)%360}var invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=rhumbBearing,module.exports.default=rhumbBearing;

},{"@turf/helpers":14,"@turf/invariant":16}],35:[function(require,module,exports){
"use strict";function rhumbDestination(r,e,t,a){if(a=a||{},!helpers.isObject(a))throw new Error("options is invalid");var i=a.units,n=a.properties;if(!r)throw new Error("origin is required");if(void 0===e||null===e)throw new Error("distance is required");if(void 0===t||null===t)throw new Error("bearing is required");if(!(e>=0))throw new Error("distance must be greater than 0");var s=helpers.convertLength(e,i,"meters"),h=invariant.getCoord(r),o=calculateRhumbDestination(h,s,t);return o[0]+=o[0]-h[0]>180?-360:h[0]-o[0]>180?360:0,helpers.point(o,n)}function calculateRhumbDestination(r,e,t,a){a=void 0===a?helpers.earthRadius:Number(a);var i=e/a,n=r[0]*Math.PI/180,s=helpers.degreesToRadians(r[1]),h=helpers.degreesToRadians(t),o=i*Math.cos(h),u=s+o;Math.abs(u)>Math.PI/2&&(u=u>0?Math.PI-u:-Math.PI-u);var l=Math.log(Math.tan(u/2+Math.PI/4)/Math.tan(s/2+Math.PI/4)),d=Math.abs(l)>1e-11?o/l:Math.cos(s);return[(180*(n+i*Math.sin(h)/d)/Math.PI+540)%360-180,180*u/Math.PI]}var helpers=require("@turf/helpers"),invariant=require("@turf/invariant");module.exports=rhumbDestination,module.exports.default=rhumbDestination;

},{"@turf/helpers":14,"@turf/invariant":16}],36:[function(require,module,exports){
"use strict";function rhumbDistance(r,t,e){if(e=e||{},!helpers.isObject(e))throw new Error("options is invalid");var a=e.units;if(!r)throw new Error("from point is required");if(!t)throw new Error("to point is required");var i=invariant.getCoord(r),n=invariant.getCoord(t);n[0]+=n[0]-i[0]>180?-360:i[0]-n[0]>180?360:0;var h=calculateRhumbDistance(i,n);return helpers.convertLength(h,"meters",a)}function calculateRhumbDistance(r,t,e){e=void 0===e?helpers.earthRadius:Number(e);var a=e,i=r[1]*Math.PI/180,n=t[1]*Math.PI/180,h=n-i,o=Math.abs(t[0]-r[0])*Math.PI/180;o>Math.PI&&(o-=2*Math.PI);var s=Math.log(Math.tan(n/2+Math.PI/4)/Math.tan(i/2+Math.PI/4)),u=Math.abs(s)>1e-11?h/s:Math.cos(i);return Math.sqrt(h*h+u*u*o*o)*a}var helpers=require("@turf/helpers"),invariant=require("@turf/invariant");module.exports=rhumbDistance,module.exports.default=rhumbDistance;

},{"@turf/helpers":14,"@turf/invariant":16}],37:[function(require,module,exports){
"use strict";function _interopDefault(r){return r&&"object"==typeof r&&"default"in r?r.default:r}function transformRotate(r,e,t){if(t=t||{},!helpers.isObject(t))throw new Error("options is invalid");var i=t.pivot,n=t.mutate;if(!r)throw new Error("geojson is required");if(void 0===e||null===e||isNaN(e))throw new Error("angle is required");return 0===e?r:(i||(i=centroid(r)),!1!==n&&void 0!==n||(r=clone(r)),meta.coordEach(r,function(r){var t=rhumbBearing(i,r),n=t+e,o=rhumbDistance(i,r),u=invariant.getCoords(rhumbDestination(i,o,n));r[0]=u[0],r[1]=u[1]}),r)}var centroid=_interopDefault(require("@turf/centroid")),rhumbBearing=_interopDefault(require("@turf/rhumb-bearing")),rhumbDistance=_interopDefault(require("@turf/rhumb-distance")),rhumbDestination=_interopDefault(require("@turf/rhumb-destination")),clone=_interopDefault(require("@turf/clone")),meta=require("@turf/meta"),invariant=require("@turf/invariant"),helpers=require("@turf/helpers");module.exports=transformRotate,module.exports.default=transformRotate;

},{"@turf/centroid":7,"@turf/clone":10,"@turf/helpers":14,"@turf/invariant":16,"@turf/meta":19,"@turf/rhumb-bearing":34,"@turf/rhumb-destination":35,"@turf/rhumb-distance":36}],38:[function(require,module,exports){
"use strict";function truncate(r,e){if(e=e||{},!helpers.isObject(e))throw new Error("options is invalid");var t=e.precision,o=e.coordinates,n=e.mutate;if(t=void 0===t||null===t||isNaN(t)?6:t,o=void 0===o||null===o||isNaN(o)?3:o,!r)throw new Error("<geojson> is required");if("number"!=typeof t)throw new Error("<precision> must be a number");if("number"!=typeof o)throw new Error("<coordinates> must be a number");!1!==n&&void 0!==n||(r=JSON.parse(JSON.stringify(r)));var i=Math.pow(10,t);return meta.coordEach(r,function(r){truncateCoords(r,i,o)}),r}function truncateCoords(r,e,t){r.length>t&&r.splice(t,r.length);for(var o=0;o<r.length;o++)r[o]=Math.round(r[o]*e)/e;return r}var meta=require("@turf/meta"),helpers=require("@turf/helpers");module.exports=truncate,module.exports.default=truncate;

},{"@turf/helpers":14,"@turf/meta":19}],39:[function(require,module,exports){
...
!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("d3-array")):"function"==typeof define&&define.amd?define(["exports","d3-array"],t):t(n.d3=n.d3||{},n.d3)}(this,function(n,t){"use strict";function r(){this.reset()}function i(n,t,r){var i=n.s=t+r,e=i-t,o=i-e;n.t=t-o+(r-e)}function e(n){return n>1?0:n<-1?Ut:Math.acos(n)}function o(n){return n>1?Xt:n<-1?-Xt:Math.asin(n)}function u(n){return(n=ir(n/2))*n}function a(){}function c(n,t){n&&cr.hasOwnProperty(n.type)&&cr[n.type](n,t)}function l(n,t,r){var i,e=-1,o=n.length-r;for(t.lineStart();++e<o;)i=n[e],t.point(i[0],i[1],i[2]);t.lineEnd()}function f(n,t){var r=-1,i=n.length;for(t.polygonStart();++r<i;)l(n[r],t,1);t.polygonEnd()}function s(){pr.point=h}function p(){g(ft,st)}function h(n,t){pr.point=g,ft=n,st=t,n*=Jt,t*=Jt,pt=n,ht=Wt(t=t/2+Yt),gt=ir(t)}function g(n,t){n*=Jt,t*=Jt,t=t/2+Yt;var r=n-pt,i=r>=0?1:-1,e=i*r,o=Wt(t),u=ir(t),a=gt*u,c=ht*o+a*Wt(e),l=a*i*ir(e);fr.add(Vt(l,c)),pt=n,ht=o,gt=u}function v(n){return[Vt(n[1],n[0]),o(n[2])]}function d(n){var t=n[0],r=n[1],i=Wt(r);return[i*Wt(t),i*ir(t),ir(r)]}function E(n,t){return n[0]*t[0]+n[1]*t[1]+n[2]*t[2]}function y(n,t){return[n[1]*t[2]-n[2]*t[1],n[2]*t[0]-n[0]*t[2],n[0]*t[1]-n[1]*t[0]]}function S(n,t){n[0]+=t[0],n[1]+=t[1],n[2]+=t[2]}function m(n,t){return[n[0]*t,n[1]*t,n[2]*t]}function M(n){var t=or(n[0]*n[0]+n[1]*n[1]+n[2]*n[2]);n[0]/=t,n[1]/=t,n[2]/=t}function x(n,t){_t.push(Nt=[vt=n,Et=n]),t<dt&&(dt=t),t>yt&&(yt=t)}function _(n,t){var r=d([n*Jt,t*Jt]);if(xt){var i=y(xt,r),e=[i[1],-i[0],0],o=y(e,i);M(o),o=v(o);var u,a=n-St,c=a>0?1:-1,l=o[0]*Ht*c,f=Kt(a)>180;f^(c*St<l&&l<c*n)?(u=o[1]*Ht)>yt&&(yt=u):(l=(l+360)%360-180,f^(c*St<l&&l<c*n)?(u=-o[1]*Ht)<dt&&(dt=u):(t<dt&&(dt=t),t>yt&&(yt=t))),f?n<St?C(vt,n)>C(vt,Et)&&(Et=n):C(n,Et)>C(vt,Et)&&(vt=n):Et>=vt?(n<vt&&(vt=n),n>Et&&(Et=n)):n>St?C(vt,n)>C(vt,Et)&&(Et=n):C(n,Et)>C(vt,Et)&&(vt=n)}else _t.push(Nt=[vt=n,Et=n]);t<dt&&(dt=t),t>yt&&(yt=t),xt=r,St=n}function N(){vr.point=_}function w(){Nt[0]=vt,Nt[1]=Et,vr.point=x,xt=null}function P(n,t){if(xt){var r=n-St;gr.add(Kt(r)>180?r+(r>0?360:-360):r)}else mt=n,Mt=t;pr.point(n,t),_(n,t)}function R(){pr.lineStart()}function A(){P(mt,Mt),pr.lineEnd(),Kt(gr)>Dt&&(vt=-(Et=180)),Nt[0]=vt,Nt[1]=Et,xt=null}function C(n,t){return(t-=n)<0?t+360:t}function j(n,t){return n[0]-t[0]}function q(n,t){return n[0]<=n[1]?n[0]<=t&&t<=n[1]:t<n[0]||n[1]<t}function z(n,t){n*=Jt,t*=Jt;var r=Wt(t);b(r*Wt(n),r*ir(n),ir(t))}function b(n,t,r){++wt,Rt+=(n-Rt)/wt,At+=(t-At)/wt,Ct+=(r-Ct)/wt}function L(){Er.point=O}function O(n,t){n*=Jt,t*=Jt;var r=Wt(t);kt=r*Wt(n),Ft=r*ir(n),It=ir(t),Er.point=G,b(kt,Ft,It)}function G(n,t){n*=Jt,t*=Jt;var r=Wt(t),i=r*Wt(n),e=r*ir(n),o=ir(t),u=Vt(or((u=Ft*o-It*e)*u+(u=It*i-kt*o)*u+(u=kt*e-Ft*i)*u),kt*i+Ft*e+It*o);Pt+=u,jt+=u*(kt+(kt=i)),qt+=u*(Ft+(Ft=e)),zt+=u*(It+(It=o)),b(kt,Ft,It)}function T(){Er.point=z}function k(){Er.point=I}function F(){B(Gt,Tt),Er.point=z}function I(n,t){Gt=n,Tt=t,n*=Jt,t*=Jt,Er.point=B;var r=Wt(t);kt=r*Wt(n),Ft=r*ir(n),It=ir(t),b(kt,Ft,It)}function B(n,t){n*=Jt,t*=Jt;var r=Wt(t),i=r*Wt(n),e=r*ir(n),u=ir(t),a=Ft*u-It*e,c=It*i-kt*u,l=kt*e-Ft*i,f=or(a*a+c*c+l*l),s=o(f),p=f&&-s/f;bt+=p*a,Lt+=p*c,Ot+=p*l,Pt+=s,jt+=s*(kt+(kt=i)),qt+=s*(Ft+(Ft=e)),zt+=s*(It+(It=u)),b(kt,Ft,It)}function D(n,t){return[n>Ut?n-Zt:n<-Ut?n+Zt:n,t]}function U(n,t,r){return(n%=Zt)?t||r?mr(Y(n),Z(t,r)):Y(n):t||r?Z(t,r):D}function X(n){return function(t,r){return t+=n,[t>Ut?t-Zt:t<-Ut?t+Zt:t,r]}}function Y(n){var t=X(n);return t.invert=X(-n),t}function Z(n,t){function r(n,t){var r=Wt(t),c=Wt(n)*r,l=ir(n)*r,f=ir(t),s=f*i+c*e;return[Vt(l*u-s*a,c*i-f*e),o(s*u+l*a)]}var i=Wt(n),e=ir(n),u=Wt(t),a=ir(t);return r.invert=function(n,t){var r=Wt(t),c=Wt(n)*r,l=ir(n)*r,f=ir(t),s=f*u-l*a;return[Vt(l*u+f*a,c*i+s*e),o(s*i-c*e)]},r}function H(n,t,r,i,e,o){if(r){var u=Wt(t),a=ir(t),c=i*r;null==e?(e=t+i*Zt,o=t-c/2):(e=J(u,e),o=J(u,o),(i>0?e<o:e>o)&&(e+=i*Zt));for(var l,f=e;i>0?f>o:f<o;f-=c)l=v([u,-a*Wt(f),-a*ir(f)]),n.point(l[0],l[1])}}function J(n,t){t=d(t),t[0]-=n,M(t);var r=e(-t[1]);return((-t[2]<0?-r:r)+Zt-Dt)%Zt}function K(n,t,r,i){this.x=n,this.z=t,this.o=r,this.e=i,this.v=!1,this.n=this.p=null}function Q(n){if(t=n.length){for(var t,r,i=0,e=n[0];++i<t;)e.n=r=n[i],r.p=e,e=r;e.n=r=n[0],r.p=e}}function V(n,r,i,e){function o(t,o){return n<=t&&t<=i&&r<=o&&o<=e}function u(t,o,u,c){var f=0,s=0;if(null==t||(f=a(t,u))!==(s=a(o,u))||l(t,o)<0^u>0)do{c.point(0===f||3===f?n:i,f>1?e:r)}while((f=(f+u+4)%4)!==s);else c.point(o[0],o[1])}function a(t,e){return Kt(t[0]-n)<Dt?e>0?0:3:Kt(t[0]-i)<Dt?e>0?2:1:Kt(t[1]-r)<Dt?e>0?1:0:e>0?3:2}function c(n,t){return l(n.x,t.x)}function l(n,t){var r=a(n,1),i=a(t,1);return r!==i?r-i:0===r?t[1]-n[1]:1===r?n[0]-t[0]:2===r?n[1]-t[1]:t[0]-n[0]}return function(a){function l(n,t){o(n,t)&&R.point(n,t)}function f(){for(var t=0,r=0,i=E.length;r<i;++r)for(var o,u,a=E[r],c=1,l=a.length,f=a[0],s=f[0],p=f[1];c<l;++c)o=s,u=p,f=a[c],s=f[0],p=f[1],u<=e?p>e&&(s-o)*(e-u)>(p-u)*(n-o)&&++t:p<=e&&(s-o)*(e-u)<(p-u)*(n-o)&&--t;return t}function s(){R=A,d=[],E=[],P=!0}function p(){var n=f(),r=P&&n,i=(d=t.merge(d)).length;(r||i)&&(a.polygonStart(),r&&(a.lineStart(),u(null,null,1,a),a.lineEnd()),i&&Tr(d,c,n,u,a),a.polygonEnd()),R=a,d=E=y=null}function h(){C.point=v,E&&E.push(y=[]),w=!0,N=!1,x=_=NaN}function g(){d&&(v(S,m),M&&N&&A.rejoin(),d.push(A.result())),C.point=l,N&&R.lineEnd()}function v(t,u){var a=o(t,u);if(E&&y.push([t,u]),w)S=t,m=u,M=a,w=!1,a&&(R.lineStart(),R.point(t,u));else if(a&&N)R.point(t,u);else{var c=[x=Math.max(Fr,Math.min(kr,x)),_=Math.max(Fr,Math.min(kr,_))],l=[t=Math.max(Fr,Math.min(kr,t)),u=Math.max(Fr,Math.min(kr,u))];Or(c,l,n,r,i,e)?(N||(R.lineStart(),R.point(c[0],c[1])),R.point(l[0],l[1]),a||R.lineEnd(),P=!1):a&&(R.lineStart(),R.point(t,u),P=!1)}x=t,_=u,N=a}var d,E,y,S,m,M,x,_,N,w,P,R=a,A=Lr(),C={point:l,lineStart:h,lineEnd:g,polygonStart:s,polygonEnd:p};return C}}function W(){Xr.point=nn,Xr.lineEnd=$}function $(){Xr.point=Xr.lineEnd=a}function nn(n,t){n*=Jt,t*=Jt,Mr=n,xr=ir(t),_r=Wt(t),Xr.point=tn}function tn(n,t){n*=Jt,t*=Jt;var r=ir(t),i=Wt(t),e=Kt(n-Mr),o=Wt(e),u=ir(e),a=i*u,c=_r*r-xr*i*o,l=xr*r+_r*i*o;Ur.add(Vt(or(a*a+c*c),l)),Mr=n,xr=r,_r=i}function rn(n,t){return!(!n||!Qr.hasOwnProperty(n.type))&&Qr[n.type](n,t)}function en(n,t){return 0===Jr(n,t)}function on(n,t){var r=Jr(n[0],n[1]);return Jr(n[0],t)+Jr(t,n[1])<=r+Dt}function un(n,t){return!!Dr(n.map(an),cn(t))}function an(n){return n=n.map(cn),n.pop(),n}function cn(n){return[n[0]*Jt,n[1]*Jt]}function ln(n,r,i){var e=t.range(n,r-Dt,i).concat(r);return function(n){return e.map(function(t){return[n,t]})}}function fn(n,r,i){var e=t.range(n,r-Dt,i).concat(r);return function(n){return e.map(function(t){return[t,n]})}}function sn(){function n(){return{type:"MultiLineString",coordinates:r()}}function r(){return t.range($t(u/E)*E,o,E).map(h).concat(t.range($t(f/y)*y,l,y).map(g)).concat(t.range($t(e/v)*v,i,v).filter(function(n){return Kt(n%E)>Dt}).map(s)).concat(t.range($t(c/d)*d,a,d).filter(function(n){return Kt(n%y)>Dt}).map(p))}var i,e,o,u,a,c,l,f,s,p,h,g,v=10,d=v,E=90,y=360,S=2.5;return n.lines=function(){return r().map(function(n){return{type:"LineString",coordinates:n}})},n.outline=function(){return{type:"Polygon",coordinates:[h(u).concat(g(l).slice(1),h(o).reverse().slice(1),g(f).reverse().slice(1))]}},n.extent=function(t){return arguments.length?n.extentMajor(t).extentMinor(t):n.extentMinor()},n.extentMajor=function(t){return arguments.length?(u=+t[0][0],o=+t[1][0],f=+t[0][1],l=+t[1][1],u>o&&(t=u,u=o,o=t),f>l&&(t=f,f=l,l=t),n.precision(S)):[[u,f],[o,l]]},n.extentMinor=function(t){return arguments.length?(e=+t[0][0],i=+t[1][0],c=+t[0][1],a=+t[1][1],e>i&&(t=e,e=i,i=t),c>a&&(t=c,c=a,a=t),n.precision(S)):[[e,c],[i,a]]},n.step=function(t){return arguments.length?n.stepMajor(t).stepMinor(t):n.stepMinor()},n.stepMajor=function(t){return arguments.length?(E=+t[0],y=+t[1],n):[E,y]},n.stepMinor=function(t){return arguments.length?(v=+t[0],d=+t[1],n):[v,d]},n.precision=function(t){return arguments.length?(S=+t,s=ln(c,a,90),p=fn(e,i,S),h=ln(f,l,90),g=fn(u,o,S),n):S},n.extentMajor([[-180,-90+Dt],[180,90-Dt]]).extentMinor([[-180,-80-Dt],[180,80+Dt]])}function pn(){return sn()()}function hn(){ri.point=gn}function gn(n,t){ri.point=vn,Nr=Pr=n,wr=Rr=t}function vn(n,t){ti.add(Rr*n-Pr*t),Pr=n,Rr=t}function dn(){vn(Nr,wr)}function En(n,t){n<ii&&(ii=n),n>oi&&(oi=n),t<ei&&(ei=t),t>ui&&(ui=t)}function yn(n,t){ci+=n,li+=t,++fi}function Sn(){Ei.point=mn}function mn(n,t){Ei.point=Mn,yn(jr=n,qr=t)}function Mn(n,t){var r=n-jr,i=t-qr,e=or(r*r+i*i);si+=e*(jr+n)/2,pi+=e*(qr+t)/2,hi+=e,yn(jr=n,qr=t)}function xn(){Ei.point=yn}function _n(){Ei.point=wn}function Nn(){Pn(Ar,Cr)}function wn(n,t){Ei.point=Pn,yn(Ar=jr=n,Cr=qr=t)}function Pn(n,t){var r=n-jr,i=t-qr,e=or(r*r+i*i);si+=e*(jr+n)/2,pi+=e*(qr+t)/2,hi+=e,e=qr*n-jr*t,gi+=e*(jr+n),vi+=e*(qr+t),di+=3*e,yn(jr=n,qr=t)}function Rn(n){this._context=n}function An(n,t){Ni.point=Cn,Si=Mi=n,mi=xi=t}function Cn(n,t){Mi-=n,xi-=t,_i.add(or(Mi*Mi+xi*xi)),Mi=n,xi=t}function jn(){this._string=[]}function qn(n){return"m0,"+n+"a"+n+","+n+" 0 1,1 0,"+-2*n+"a"+n+","+n+" 0 1,1 0,"+2*n+"z"}function zn(n){return n.length>1}function bn(n,t){return((n=n.x)[0]<0?n[1]-Xt-Dt:Xt-n[1])-((t=t.x)[0]<0?t[1]-Xt-Dt:Xt-t[1])}function Ln(n){var t,r=NaN,i=NaN,e=NaN;return{lineStart:function(){n.lineStart(),t=1},point:function(o,u){var a=o>0?Ut:-Ut,c=Kt(o-r);Kt(c-Ut)<Dt?(n.point(r,i=(i+u)/2>0?Xt:-Xt),n.point(e,i),n.lineEnd(),n.lineStart(),n.point(a,i),n.point(o,i),t=0):e!==a&&c>=Ut&&(Kt(r-e)<Dt&&(r-=e*Dt),Kt(o-a)<Dt&&(o-=a*Dt),i=On(r,i,o,u),n.point(e,i),n.lineEnd(),n.lineStart(),n.point(a,i),t=0),n.point(r=o,i=u),e=a},lineEnd:function(){n.lineEnd(),r=i=NaN},clean:function(){return 2-t}}}function On(n,t,r,i){var e,o,u=ir(n-r);return Kt(u)>Dt?Qt((ir(t)*(o=Wt(i))*ir(r)-ir(i)*(e=Wt(t))*ir(n))/(e*o*u)):(t+i)/2}function Gn(n,t,r,i){var e;if(null==n)e=r*Xt,i.point(-Ut,e),i.point(0,e),i.point(Ut,e),i.point(Ut,0),i.point(Ut,-e),i.point(0,-e),i.point(-Ut,-e),i.point(-Ut,0),i.point(-Ut,e);else if(Kt(n[0]-t[0])>Dt){var o=n[0]<t[0]?Ut:-Ut;e=r*o/2,i.point(-o,e),i.point(0,e),i.point(o,e)}else i.point(t[0],t[1])}function Tn(n){return function(t){var r=new kn;for(var i in n)r[i]=n[i];return r.stream=t,r}}function kn(){}function Fn(n,t,r){var i=t[1][0]-t[0][0],e=t[1][1]-t[0][1],o=n.clipExtent&&n.clipExtent();n.scale(150).translate([0,0]),null!=o&&n.clipExtent(null),lr(r,n.stream(ai));var u=ai.result(),a=Math.min(i/(u[1][0]-u[0][0]),e/(u[1][1]-u[0][1])),c=+t[0][0]+(i-a*(u[1][0]+u[0][0]))/2,l=+t[0][1]+(e-a*(u[1][1]+u[0][1]))/2;return null!=o&&n.clipExtent(o),n.scale(150*a).translate([c,l])}function In(n,t,r){return Fn(n,[[0,0],t],r)}function Bn(n){return Tn({point:function(t,r){t=n(t,r),this.stream.point(t[0],t[1])}})}function Dn(n,t){function r(i,e,u,a,c,l,f,s,p,h,g,v,d,E){var y=f-i,S=s-e,m=y*y+S*S;if(m>4*t&&d--){var M=a+h,x=c+g,_=l+v,N=or(M*M+x*x+_*_),w=o(_/=N),P=Kt(Kt(_)-1)<Dt||Kt(u-p)<Dt?(u+p)/2:Vt(x,M),R=n(P,w),A=R[0],C=R[1],j=A-i,q=C-e,z=S*j-y*q;(z*z/m>t||Kt((y*j+S*q)/m-.5)>.3||a*h+c*g+l*v<qi)&&(r(i,e,u,a,c,l,A,C,P,M/=N,x/=N,_,d,E),E.point(A,C),r(A,C,P,M,x,_,f,s,p,h,g,v,d,E))}}return function(t){function i(r,i){r=n(r,i),t.point(r[0],r[1])}function e(){y=NaN,_.point=o,t.lineStart()}function o(i,e){var o=d([i,e]),u=n(i,e);r(y,S,E,m,M,x,y=u[0],S=u[1],E=i,m=o[0],M=o[1],x=o[2],ji,t),t.point(y,S)}function u(){_.point=i,t.lineEnd()}function a(){e(),_.point=c,_.lineEnd=l}function c(n,t){o(f=n,t),s=y,p=S,h=m,g=M,v=x,_.point=o}function l(){r(y,S,E,m,M,x,s,p,f,h,g,v,ji,t),_.lineEnd=u,u()}var f,s,p,h,g,v,E,y,S,m,M,x,_={point:i,lineStart:e,lineEnd:u,polygonStart:function(){t.polygonStart(),_.lineStart=a},polygonEnd:function(){t.polygonEnd(),_.lineStart=e}};return _}}function Un(n){return Xn(function(){return n})()}function Xn(n){function t(n){return n=f(n[0]*Jt,n[1]*Jt),[n[0]*d+a,c-n[1]*d]}function r(n){return(n=f.invert((n[0]-a)/d,(c-n[1])/d))&&[n[0]*Ht,n[1]*Ht]}function i(n,t){return n=u(n,t),[n[0]*d+a,c-n[1]*d]}function e(){f=mr(l=U(M,x,_),u);var n=u(S,m);return a=E-n[0]*d,c=y+n[1]*d,o()}function o(){return g=v=null,t}var u,a,c,l,f,s,p,h,g,v,d=150,E=480,y=250,S=0,m=0,M=0,x=0,_=0,N=null,w=Ri,P=null,R=$r,A=.5,C=zi(i,A);return t.stream=function(n){return g&&v===n?g:g=bi(w(l,C(R(v=n))))},t.clipAngle=function(n){return arguments.length?(w=+n?Ai(N=n*Jt,6*Jt):(N=null,Ri),o()):N*Ht},t.clipExtent=function(n){return arguments.length?(R=null==n?(P=s=p=h=null,$r):V(P=+n[0][0],s=+n[0][1],p=+n[1][0],h=+n[1][1]),o()):null==P?null:[[P,s],[p,h]]},t.scale=function(n){return arguments.length?(d=+n,e()):d},t.translate=function(n){return arguments.length?(E=+n[0],y=+n[1],e()):[E,y]},t.center=function(n){return arguments.length?(S=n[0]%360*Jt,m=n[1]%360*Jt,e()):[S*Ht,m*Ht]},t.rotate=function(n){return arguments.length?(M=n[0]%360*Jt,x=n[1]%360*Jt,_=n.length>2?n[2]%360*Jt:0,e()):[M*Ht,x*Ht,_*Ht]},t.precision=function(n){return arguments.length?(C=zi(i,A=n*n),o()):or(A)},t.fitExtent=function(n,r){return Fn(t,n,r)},t.fitSize=function(n,r){return In(t,n,r)},function(){return u=n.apply(this,arguments),t.invert=u.invert&&r,e()}}function Yn(n){var t=0,r=Ut/3,i=Xn(n),e=i(t,r);return e.parallels=function(n){return arguments.length?i(t=n[0]*Jt,r=n[1]*Jt):[t*Ht,r*Ht]},e}function Zn(n){function t(n,t){return[n*r,ir(t)/r]}var r=Wt(n);return t.invert=function(n,t){return[n/r,o(t*r)]},t}function Hn(n,t){function r(n,t){var r=or(u-2*e*ir(t))/e;return[r*ir(n*=e),a-r*Wt(n)]}var i=ir(n),e=(i+ir(t))/2;if(Kt(e)<Dt)return Zn(n);var u=1+i*(2*e-i),a=or(u)/e;return r.invert=function(n,t){var r=a-t;return[Vt(n,Kt(r))/e*er(r),o((u-(n*n+r*r)*e*e)/(2*e))]},r}function Jn(n){var t=n.length;return{point:function(r,i){for(var e=-1;++e<t;)n[e].point(r,i)},sphere:function(){for(var r=-1;++r<t;)n[r].sphere()},lineStart:function(){for(var r=-1;++r<t;)n[r].lineStart()},lineEnd:function(){for(var r=-1;++r<t;)n[r].lineEnd()},polygonStart:function(){for(var r=-1;++r<t;)n[r].polygonStart()},polygonEnd:function(){for(var r=-1;++r<t;)n[r].polygonEnd()}}}function Kn(n){return function(t,r){var i=Wt(t),e=Wt(r),o=n(i*e);return[o*e*ir(t),o*ir(r)]}}function Qn(n){return function(t,r){var i=or(t*t+r*r),e=n(i),u=ir(e),a=Wt(e);return[Vt(t*u,i*a),o(i&&r*u/i)]}}function Vn(n,t){return[n,tr(ur((Xt+t)/2))]}function Wn(n){function t(){var t=Ut*a(),u=o(zr(o.rotate()).invert([0,0]));return l(null==f?[[u[0]-t,u[1]-t],[u[0]+t,u[1]+t]]:n===Vn?[[Math.max(u[0]-t,f),r],[Math.min(u[0]+t,i),e]]:[[f,Math.max(u[1]-t,r)],[i,Math.min(u[1]+t,e)]])}var r,i,e,o=Un(n),u=o.center,a=o.scale,c=o.translate,l=o.clipExtent,f=null;return o.scale=function(n){return arguments.length?(a(n),t()):a()},o.translate=function(n){return arguments.length?(c(n),t()):c()},o.center=function(n){return arguments.length?(u(n),t()):u()},o.clipExtent=function(n){return arguments.length?(null==n?f=r=i=e=null:(f=+n[0][0],r=+n[0][1],i=+n[1][0],e=+n[1][1]),t()):null==f?null:[[f,r],[i,e]]},t()}function $n(n){return ur((Xt+n)/2)}function nt(n,t){function r(n,t){o>0?t<-Xt+Dt&&(t=-Xt+Dt):t>Xt-Dt&&(t=Xt-Dt);var r=o/rr($n(t),e);return[r*ir(e*n),o-r*Wt(e*n)]}var i=Wt(n),e=n===t?ir(n):tr(i/Wt(t))/tr($n(t)/$n(n)),o=i*rr($n(n),e)/e;return e?(r.invert=function(n,t){var r=o-t,i=er(e)*or(n*n+r*r);return[Vt(n,Kt(r))/e*er(r),2*Qt(rr(o/i,1/e))-Xt]},r):Vn}function tt(n,t){return[n,t]}function rt(n,t){function r(n,t){var r=o-t,i=e*n;return[r*ir(i),o-r*Wt(i)]}var i=Wt(n),e=n===t?ir(n):(i-Wt(t))/(t-n),o=i/e+n;return Kt(e)<Dt?tt:(r.invert=function(n,t){var r=o-t;return[Vt(n,Kt(r))/e*er(r),o-er(e)*or(n*n+r*r)]},r)}function it(n,t){var r=Wt(t),i=Wt(n)*r;return[r*ir(n)/i,ir(t)/i]}function et(n,t,r,i){return 1===n&&1===t&&0===r&&0===i?$r:Tn({point:function(e,o){this.stream.point(e*n+r,o*t+i)}})}function ot(n,t){var r=t*t,i=r*r;return[n*(.8707-.131979*r+i*(i*(.003971*r-.001529*i)-.013791)),t*(1.007226+r*(.015085+i*(.028874*r-.044475-.005916*i)))]}function ut(n,t){return[Wt(t)*ir(n),ir(t)]}function at(n,t){var r=Wt(t),i=1+Wt(n)*r;return[r*ir(n)/i,ir(t)/i]}function ct(n,t){return[tr(ur((Xt+t)/2)),-n]}var lt=function(){return new r};r.prototype={constructor:r,reset:function(){this.s=this.t=0},add:function(n){i(Bt,n,this.t),i(this,Bt.s,this.s),this.s?this.t+=Bt.t:this.s=Bt.t},valueOf:function(){return this.s}};var ft,st,pt,ht,gt,vt,dt,Et,yt,St,mt,Mt,xt,_t,Nt,wt,Pt,Rt,At,Ct,jt,qt,zt,bt,Lt,Ot,Gt,Tt,kt,Ft,It,Bt=new r,Dt=1e-6,Ut=Math.PI,Xt=Ut/2,Yt=Ut/4,Zt=2*Ut,Ht=180/Ut,Jt=Ut/180,Kt=Math.abs,Qt=Math.atan,Vt=Math.atan2,Wt=Math.cos,$t=Math.ceil,nr=Math.exp,tr=Math.log,rr=Math.pow,ir=Math.sin,er=Math.sign||function(n){return n>0?1:n<0?-1:0},or=Math.sqrt,ur=Math.tan,ar={Feature:function(n,t){c(n.geometry,t)},FeatureCollection:function(n,t){for(var r=n.features,i=-1,e=r.length;++i<e;)c(r[i].geometry,t)}},cr={Sphere:function(n,t){t.sphere()},Point:function(n,t){n=n.coordinates,t.point(n[0],n[1],n[2])},MultiPoint:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)n=r[i],t.point(n[0],n[1],n[2])},LineString:function(n,t){l(n.coordinates,t,0)},MultiLineString:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)l(r[i],t,0)},Polygon:function(n,t){f(n.coordinates,t)},MultiPolygon:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)f(r[i],t)},GeometryCollection:function(n,t){for(var r=n.geometries,i=-1,e=r.length;++i<e;)c(r[i],t)}},lr=function(n,t){n&&ar.hasOwnProperty(n.type)?ar[n.type](n,t):c(n,t)},fr=lt(),sr=lt(),pr={point:a,lineStart:a,lineEnd:a,polygonStart:function(){fr.reset(),pr.lineStart=s,pr.lineEnd=p},polygonEnd:function(){var n=+fr;sr.add(n<0?Zt+n:n),this.lineStart=this.lineEnd=this.point=a},sphere:function(){sr.add(Zt)}},hr=function(n){return sr.reset(),lr(n,pr),2*sr},gr=lt(),vr={point:x,lineStart:N,lineEnd:w,polygonStart:function(){vr.point=P,vr.lineStart=R,vr.lineEnd=A,gr.reset(),pr.polygonStart()},polygonEnd:function(){pr.polygonEnd(),vr.point=x,vr.lineStart=N,vr.lineEnd=w,fr<0?(vt=-(Et=180),dt=-(yt=90)):gr>Dt?yt=90:gr<-Dt&&(dt=-90),Nt[0]=vt,Nt[1]=Et}},dr=function(n){var t,r,i,e,o,u,a;if(yt=Et=-(vt=dt=1/0),_t=[],lr(n,vr),r=_t.length){for(_t.sort(j),t=1,i=_t[0],o=[i];t<r;++t)e=_t[t],q(i,e[0])||q(i,e[1])?(C(i[0],e[1])>C(i[0],i[1])&&(i[1]=e[1]),C(e[0],i[1])>C(i[0],i[1])&&(i[0]=e[0])):o.push(i=e);for(u=-1/0,r=o.length-1,t=0,i=o[r];t<=r;i=e,++t)e=o[t],(a=C(i[1],e[0]))>u&&(u=a,vt=e[0],Et=i[1])}return _t=Nt=null,vt===1/0||dt===1/0?[[NaN,NaN],[NaN,NaN]]:[[vt,dt],[Et,yt]]},Er={sphere:a,point:z,lineStart:L,lineEnd:T,polygonStart:function(){Er.lineStart=k,Er.lineEnd=F},polygonEnd:function(){Er.lineStart=L,Er.lineEnd=T}},yr=function(n){wt=Pt=Rt=At=Ct=jt=qt=zt=bt=Lt=Ot=0,lr(n,Er);var t=bt,r=Lt,i=Ot,e=t*t+r*r+i*i;return e<1e-12&&(t=jt,r=qt,i=zt,Pt<Dt&&(t=Rt,r=At,i=Ct),(e=t*t+r*r+i*i)<1e-12)?[NaN,NaN]:[Vt(r,t)*Ht,o(i/or(e))*Ht]},Sr=function(n){return function(){return n}},mr=function(n,t){function r(r,i){return r=n(r,i),t(r[0],r[1])}return n.invert&&t.invert&&(r.invert=function(r,i){return(r=t.invert(r,i))&&n.invert(r[0],r[1])}),r};D.invert=D;var Mr,xr,_r,Nr,wr,Pr,Rr,Ar,Cr,jr,qr,zr=function(n){function t(t){return t=n(t[0]*Jt,t[1]*Jt),t[0]*=Ht,t[1]*=Ht,t}return n=U(n[0]*Jt,n[1]*Jt,n.length>2?n[2]*Jt:0),t.invert=function(t){return t=n.invert(t[0]*Jt,t[1]*Jt),t[0]*=Ht,t[1]*=Ht,t},t},br=function(){function n(n,t){r.push(n=i(n,t)),n[0]*=Ht,n[1]*=Ht}function t(){var n=e.apply(this,arguments),t=o.apply(this,arguments)*Jt,c=u.apply(this,arguments)*Jt;return r=[],i=U(-n[0]*Jt,-n[1]*Jt,0).invert,H(a,t,c,1),n={type:"Polygon",coordinates:[r]},r=i=null,n}var r,i,e=Sr([0,0]),o=Sr(90),u=Sr(6),a={point:n};return t.center=function(n){return arguments.length?(e="function"==typeof n?n:Sr([+n[0],+n[1]]),t):e},t.radius=function(n){return arguments.length?(o="function"==typeof n?n:Sr(+n),t):o},t.precision=function(n){return arguments.length?(u="function"==typeof n?n:Sr(+n),t):u},t},Lr=function(){var n,t=[];return{point:function(t,r){n.push([t,r])},lineStart:function(){t.push(n=[])},lineEnd:a,rejoin:function(){t.length>1&&t.push(t.pop().concat(t.shift()))},result:function(){var r=t;return t=[],n=null,r}}},Or=function(n,t,r,i,e,o){var u,a=n[0],c=n[1],l=t[0],f=t[1],s=0,p=1,h=l-a,g=f-c;if(u=r-a,h||!(u>0)){if(u/=h,h<0){if(u<s)return;u<p&&(p=u)}else if(h>0){if(u>p)return;u>s&&(s=u)}if(u=e-a,h||!(u<0)){if(u/=h,h<0){if(u>p)return;u>s&&(s=u)}else if(h>0){if(u<s)return;u<p&&(p=u)}if(u=i-c,g||!(u>0)){if(u/=g,g<0){if(u<s)return;u<p&&(p=u)}else if(g>0){if(u>p)return;u>s&&(s=u)}if(u=o-c,g||!(u<0)){if(u/=g,g<0){if(u>p)return;u>s&&(s=u)}else if(g>0){if(u<s)return;u<p&&(p=u)}return s>0&&(n[0]=a+s*h,n[1]=c+s*g),p<1&&(t[0]=a+p*h,t[1]=c+p*g),!0}}}}},Gr=function(n,t){return Kt(n[0]-t[0])<Dt&&Kt(n[1]-t[1])<Dt},Tr=function(n,t,r,i,e){var o,u,a=[],c=[];if(n.forEach(function(n){if(!((t=n.length-1)<=0)){var t,r,i=n[0],u=n[t];if(Gr(i,u)){for(e.lineStart(),o=0;o<t;++o)e.point((i=n[o])[0],i[1]);return void e.lineEnd()}a.push(r=new K(i,n,null,!0)),c.push(r.o=new K(i,null,r,!1)),a.push(r=new K(u,n,null,!1)),c.push(r.o=new K(u,null,r,!0))}}),a.length){for(c.sort(t),Q(a),Q(c),o=0,u=c.length;o<u;++o)c[o].e=r=!r;for(var l,f,s=a[0];;){for(var p=s,h=!0;p.v;)if((p=p.n)===s)return;l=p.z,e.lineStart();do{if(p.v=p.o.v=!0,p.e){if(h)for(o=0,u=l.length;o<u;++o)e.point((f=l[o])[0],f[1]);else i(p.x,p.n.x,1,e);p=p.n}else{if(h)for(l=p.p.z,o=l.length-1;o>=0;--o)e.point((f=l[o])[0],f[1]);else i(p.x,p.p.x,-1,e);p=p.p}p=p.o,l=p.z,h=!h}while(!p.v);e.lineEnd()}}},kr=1e9,Fr=-kr,Ir=function(){var n,t,r,i=0,e=0,o=960,u=500;return r={stream:function(r){return n&&t===r?n:n=V(i,e,o,u)(t=r)},extent:function(a){return arguments.length?(i=+a[0][0],e=+a[0][1],o=+a[1][0],u=+a[1][1],n=t=null,r):[[i,e],[o,u]]}}},Br=lt(),Dr=function(n,t){var r=t[0],i=t[1],e=[ir(r),-Wt(r),0],u=0,a=0;Br.reset();for(var c=0,l=n.length;c<l;++c)if(s=(f=n[c]).length)for(var f,s,p=f[s-1],h=p[0],g=p[1]/2+Yt,v=ir(g),E=Wt(g),S=0;S<s;++S,h=x,v=N,E=w,p=m){var m=f[S],x=m[0],_=m[1]/2+Yt,N=ir(_),w=Wt(_),P=x-h,R=P>=0?1:-1,A=R*P,C=A>Ut,j=v*N;if(Br.add(Vt(j*R*ir(A),E*w+j*Wt(A))),u+=C?P+R*Zt:P,C^h>=r^x>=r){var q=y(d(p),d(m));M(q);var z=y(e,q);M(z);var b=(C^P>=0?-1:1)*o(z[2]);(i>b||i===b&&(q[0]||q[1]))&&(a+=C^P>=0?1:-1)}}return(u<-Dt||u<Dt&&Br<-Dt)^1&a},Ur=lt(),Xr={sphere:a,point:a,lineStart:W,lineEnd:a,polygonStart:a,polygonEnd:a},Yr=function(n){return Ur.reset(),lr(n,Xr),+Ur},Zr=[null,null],Hr={type:"LineString",coordinates:Zr},Jr=function(n,t){return Zr[0]=n,Zr[1]=t,Yr(Hr)},Kr={Feature:function(n,t){return rn(n.geometry,t)},FeatureCollection:function(n,t){for(var r=n.features,i=-1,e=r.length;++i<e;)if(rn(r[i].geometry,t))return!0;return!1}},Qr={Sphere:function(){return!0},Point:function(n,t){return en(n.coordinates,t)},MultiPoint:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)if(en(r[i],t))return!0;return!1},LineString:function(n,t){return on(n.coordinates,t)},MultiLineString:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)if(on(r[i],t))return!0;return!1},Polygon:function(n,t){return un(n.coordinates,t)},MultiPolygon:function(n,t){for(var r=n.coordinates,i=-1,e=r.length;++i<e;)if(un(r[i],t))return!0;return!1},GeometryCollection:function(n,t){for(var r=n.geometries,i=-1,e=r.length;++i<e;)if(rn(r[i],t))return!0;return!1}},Vr=function(n,t){return(n&&Kr.hasOwnProperty(n.type)?Kr[n.type]:rn)(n,t)},Wr=function(n,t){var r=n[0]*Jt,i=n[1]*Jt,e=t[0]*Jt,a=t[1]*Jt,c=Wt(i),l=ir(i),f=Wt(a),s=ir(a),p=c*Wt(r),h=c*ir(r),g=f*Wt(e),v=f*ir(e),d=2*o(or(u(a-i)+c*f*u(e-r))),E=ir(d),y=d?function(n){var t=ir(n*=d)/E,r=ir(d-n)/E,i=r*p+t*g,e=r*h+t*v,o=r*l+t*s;return[Vt(e,i)*Ht,Vt(o,or(i*i+e*e))*Ht]}:function(){return[r*Ht,i*Ht]};return y.distance=d,y},$r=function(n){return n},ni=lt(),ti=lt(),ri={point:a,lineStart:a,lineEnd:a,polygonStart:function(){ri.lineStart=hn,ri.lineEnd=dn},polygonEnd:function(){ri.lineStart=ri.lineEnd=ri.point=a,ni.add(Kt(ti)),ti.reset()},result:function(){var n=ni/2;return ni.reset(),n}},ii=1/0,ei=ii,oi=-ii,ui=oi,ai={point:En,lineStart:a,lineEnd:a,polygonStart:a,polygonEnd:a,result:function(){var n=[[ii,ei],[oi,ui]];return oi=ui=-(ei=ii=1/0),n}},ci=0,li=0,fi=0,si=0,pi=0,hi=0,gi=0,vi=0,di=0,Ei={point:yn,lineStart:Sn,lineEnd:xn,polygonStart:function(){Ei.lineStart=_n,Ei.lineEnd=Nn},polygonEnd:function(){Ei.point=yn,Ei.lineStart=Sn,Ei.lineEnd=xn},result:function(){var n=di?[gi/di,vi/di]:hi?[si/hi,pi/hi]:fi?[ci/fi,li/fi]:[NaN,NaN];return ci=li=fi=si=pi=hi=gi=vi=di=0,n}};Rn.prototype={_radius:4.5,pointRadius:function(n){return this._radius=n,this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){0===this._line&&this._context.closePath(),this._point=NaN},point:function(n,t){switch(this._point){case 0:this._context.moveTo(n,t),this._point=1;break;case 1:this._context.lineTo(n,t);break;default:this._context.moveTo(n+this._radius,t),this._context.arc(n,t,this._radius,0,Zt)}},result:a};var yi,Si,mi,Mi,xi,_i=lt(),Ni={point:a,lineStart:function(){Ni.point=An},lineEnd:function(){yi&&Cn(Si,mi),Ni.point=a},polygonStart:function(){yi=!0},polygonEnd:function(){yi=null},result:function(){var n=+_i;return _i.reset(),n}};jn.prototype={_radius:4.5,_circle:qn(4.5),pointRadius:function(n){return(n=+n)!==this._radius&&(this._radius=n,this._circle=null),this},polygonStart:function(){this._line=0},polygonEnd:function(){this._line=NaN},lineStart:function(){this._point=0},lineEnd:function(){0===this._line&&this._string.push("Z"),this._point=NaN},point:function(n,t){switch(this._point){case 0:this._string.push("M",n,",",t),this._point=1;break;case 1:this._string.push("L",n,",",t);break;default:null==this._circle&&(this._circle=qn(this._radius)),this._string.push("M",n,",",t,this._circle)}},result:function(){if(this._string.length){var n=this._string.join("");return this._string=[],n}return null}};var wi=function(n,t){function r(n){return n&&("function"==typeof o&&e.pointRadius(+o.apply(this,arguments)),lr(n,i(e))),e.result()}var i,e,o=4.5;return r.area=function(n){return lr(n,i(ri)),ri.result()},r.measure=function(n){return lr(n,i(Ni)),Ni.result()},r.bounds=function(n){return lr(n,i(ai)),ai.result()},r.centroid=function(n){return lr(n,i(Ei)),Ei.result()},r.projection=function(t){return arguments.length?(i=null==t?(n=null,$r):(n=t).stream,r):n},r.context=function(n){return arguments.length?(e=null==n?(t=null,new jn):new Rn(t=n),"function"!=typeof o&&e.pointRadius(o),r):t},r.pointRadius=function(n){return arguments.length?(o="function"==typeof n?n:(e.pointRadius(+n),+n),r):o},r.projection(n).context(t)},Pi=function(n,r,i,e){return function(o,u){function a(t,r){var i=o(t,r);n(t=i[0],r=i[1])&&u.point(t,r)}function c(n,t){var r=o(n,t);E.point(r[0],r[1])}function l(){x.point=c,E.lineStart()}function f(){x.point=a,E.lineEnd()}function s(n,t){d.push([n,t]);var r=o(n,t);m.point(r[0],r[1])}function p(){m.lineStart(),d=[]}function h(){s(d[0][0],d[0][1]),m.lineEnd();var n,t,r,i,e=m.clean(),o=S.result(),a=o.length;if(d.pop(),g.push(d),d=null,a)if(1&e){if(r=o[0],(t=r.length-1)>0){for(M||(u.polygonStart(),M=!0),u.lineStart(),n=0;n<t;++n)u.point((i=r[n])[0],i[1]);u.lineEnd()}}else a>1&&2&e&&o.push(o.pop().concat(o.shift())),v.push(o.filter(zn))}var g,v,d,E=r(u),y=o.invert(e[0],e[1]),S=Lr(),m=r(S),M=!1,x={point:a,lineStart:l,lineEnd:f,polygonStart:function(){x.point=s,x.lineStart=p,x.lineEnd=h,v=[],g=[]},polygonEnd:function(){x.point=a,x.lineStart=l,x.lineEnd=f,v=t.merge(v);var n=Dr(g,y);v.length?(M||(u.polygonStart(),M=!0),Tr(v,bn,n,i,u)):n&&(M||(u.polygonStart(),M=!0),u.lineStart(),i(null,null,1,u),u.lineEnd()),M&&(u.polygonEnd(),M=!1),v=g=null},sphere:function(){u.polygonStart(),u.lineStart(),i(null,null,1,u),u.lineEnd(),u.polygonEnd()}};return x}},Ri=Pi(function(){return!0},Ln,Gn,[-Ut,-Xt]),Ai=function(n,t){function r(r,i,e,o){H(o,n,t,e,r,i)}function i(n,t){return Wt(n)*Wt(t)>a}function e(n){var t,r,e,a,f;return{lineStart:function(){a=e=!1,f=1},point:function(s,p){var h,g=[s,p],v=i(s,p),d=c?v?0:u(s,p):v?u(s+(s<0?Ut:-Ut),p):0;if(!t&&(a=e=v)&&n.lineStart(),v!==e&&(!(h=o(t,g))||Gr(t,h)||Gr(g,h))&&(g[0]+=Dt,g[1]+=Dt,v=i(g[0],g[1])),v!==e)f=0,v?(n.lineStart(),h=o(g,t),n.point(h[0],h[1])):(h=o(t,g),n.point(h[0],h[1]),n.lineEnd()),t=h;else if(l&&t&&c^v){var E;d&r||!(E=o(g,t,!0))||(f=0,c?(n.lineStart(),n.point(E[0][0],E[0][1]),n.point(E[1][0],E[1][1]),n.lineEnd()):(n.point(E[1][0],E[1][1]),n.lineEnd(),n.lineStart(),n.point(E[0][0],E[0][1])))}!v||t&&Gr(t,g)||n.point(g[0],g[1]),t=g,e=v,r=d},lineEnd:function(){e&&n.lineEnd(),t=null},clean:function(){return f|(a&&e)<<1}}}function o(n,t,r){var i=d(n),e=d(t),o=[1,0,0],u=y(i,e),c=E(u,u),l=u[0],f=c-l*l;if(!f)return!r&&n;var s=a*c/f,p=-a*l/f,h=y(o,u),g=m(o,s);S(g,m(u,p));var M=h,x=E(g,M),_=E(M,M),N=x*x-_*(E(g,g)-1);if(!(N<0)){var w=or(N),P=m(M,(-x-w)/_);if(S(P,g),P=v(P),!r)return P;var R,A=n[0],C=t[0],j=n[1],q=t[1];C<A&&(R=A,A=C,C=R);var z=C-A,b=Kt(z-Ut)<Dt,L=b||z<Dt;if(!b&&q<j&&(R=j,j=q,q=R),L?b?j+q>0^P[1]<(Kt(P[0]-A)<Dt?j:q):j<=P[1]&&P[1]<=q:z>Ut^(A<=P[0]&&P[0]<=C)){var O=m(M,(-x+w)/_);return S(O,g),[P,v(O)]}}}function u(t,r){var i=c?n:Ut-n,e=0;return t<-i?e|=1:t>i&&(e|=2),r<-i?e|=4:r>i&&(e|=8),e}var a=Wt(n),c=a>0,l=Kt(a)>Dt;return Pi(i,e,r,c?[0,-n]:[-Ut,n-Ut])},Ci=function(n){return{stream:Tn(n)}};kn.prototype={constructor:kn,point:function(n,t){this.stream.point(n,t)},sphere:function(){this.stream.sphere()},lineStart:function(){this.stream.lineStart()},lineEnd:function(){this.stream.lineEnd()},polygonStart:function(){this.stream.polygonStart()},polygonEnd:function(){this.stream.polygonEnd()}};var ji=16,qi=Wt(30*Jt),zi=function(n,t){return+t?Dn(n,t):Bn(n)},bi=Tn({point:function(n,t){this.stream.point(n*Jt,t*Jt)}}),Li=function(){return Yn(Hn).scale(155.424).center([0,33.6442])},Oi=function(){return Li().parallels([29.5,45.5]).scale(1070).translate([480,250]).rotate([96,0]).center([-.6,38.7])},Gi=function(){function n(n){var t=n[0],r=n[1];return a=null,e.point(t,r),a||(o.point(t,r),a)||(u.point(t,r),a)}function t(){return r=i=null,n}var r,i,e,o,u,a,c=Oi(),l=Li().rotate([154,0]).center([-2,58.5]).parallels([55,65]),f=Li().rotate([157,0]).center([-3,19.9]).parallels([8,18]),s={point:function(n,t){a=[n,t]}};return n.invert=function(n){var t=c.scale(),r=c.translate(),i=(n[0]-r[0])/t,e=(n[1]-r[1])/t;return(e>=.12&&e<.234&&i>=-.425&&i<-.214?l:e>=.166&&e<.234&&i>=-.214&&i<-.115?f:c).invert(n)},n.stream=function(n){return r&&i===n?r:r=Jn([c.stream(i=n),l.stream(n),f.stream(n)])},n.precision=function(n){return arguments.length?(c.precision(n),l.precision(n),f.precision(n),t()):c.precision()},n.scale=function(t){return arguments.length?(c.scale(t),l.scale(.35*t),f.scale(t),n.translate(c.translate())):c.scale()},n.translate=function(n){if(!arguments.length)return c.translate();var r=c.scale(),i=+n[0],a=+n[1];return e=c.translate(n).clipExtent([[i-.455*r,a-.238*r],[i+.455*r,a+.238*r]]).stream(s),o=l.translate([i-.307*r,a+.201*r]).clipExtent([[i-.425*r+Dt,a+.12*r+Dt],[i-.214*r-Dt,a+.234*r-Dt]]).stream(s),u=f.translate([i-.205*r,a+.212*r]).clipExtent([[i-.214*r+Dt,a+.166*r+Dt],[i-.115*r-Dt,a+.234*r-Dt]]).stream(s),t()},n.fitExtent=function(t,r){return Fn(n,t,r)},n.fitSize=function(t,r){return In(n,t,r)},n.scale(1070)},Ti=Kn(function(n){return or(2/(1+n))});Ti.invert=Qn(function(n){return 2*o(n/2)});var ki=function(){return Un(Ti).scale(124.75).clipAngle(179.999)},Fi=Kn(function(n){return(n=e(n))&&n/ir(n)});Fi.invert=Qn(function(n){return n});var Ii=function(){return Un(Fi).scale(79.4188).clipAngle(179.999)};Vn.invert=function(n,t){return[n,2*Qt(nr(t))-Xt]};var Bi=function(){return Wn(Vn).scale(961/Zt)},Di=function(){return Yn(nt).scale(109.5).parallels([30,30])};tt.invert=tt;var Ui=function(){return Un(tt).scale(152.63)},Xi=function(){return Yn(rt).scale(131.154).center([0,13.9389])};it.invert=Qn(Qt);var Yi=function(){return Un(it).scale(144.049).clipAngle(60)},Zi=function(){function n(){return e=o=null,u}var t,r,i,e,o,u,a=1,c=0,l=0,f=1,s=1,p=$r,h=null,g=$r;return u={stream:function(n){return e&&o===n?e:e=p(g(o=n))},clipExtent:function(e){return arguments.length?(g=null==e?(h=t=r=i=null,$r):V(h=+e[0][0],t=+e[0][1],r=+e[1][0],i=+e[1][1]),n()):null==h?null:[[h,t],[r,i]]},scale:function(t){
return arguments.length?(p=et((a=+t)*f,a*s,c,l),n()):a},translate:function(t){return arguments.length?(p=et(a*f,a*s,c=+t[0],l=+t[1]),n()):[c,l]},reflectX:function(t){return arguments.length?(p=et(a*(f=t?-1:1),a*s,c,l),n()):f<0},reflectY:function(t){return arguments.length?(p=et(a*f,a*(s=t?-1:1),c,l),n()):s<0},fitExtent:function(n,t){return Fn(u,n,t)},fitSize:function(n,t){return In(u,n,t)}}};ot.invert=function(n,t){var r,i=t,e=25;do{var o=i*i,u=o*o;i-=r=(i*(1.007226+o*(.015085+u*(.028874*o-.044475-.005916*u)))-t)/(1.007226+o*(.045255+u*(.259866*o-.311325-.005916*11*u)))}while(Kt(r)>Dt&&--e>0);return[n/(.8707+(o=i*i)*(o*(o*o*o*(.003971-.001529*o)-.013791)-.131979)),i]};var Hi=function(){return Un(ot).scale(175.295)};ut.invert=Qn(o);var Ji=function(){return Un(ut).scale(249.5).clipAngle(90+Dt)};at.invert=Qn(function(n){return 2*Qt(n)});var Ki=function(){return Un(at).scale(250).clipAngle(142)};ct.invert=function(n,t){return[-t,2*Qt(nr(n))-Xt]};var Qi=function(){var n=Wn(ct),t=n.center,r=n.rotate;return n.center=function(n){return arguments.length?t([-n[1],n[0]]):(n=t(),[n[1],-n[0]])},n.rotate=function(n){return arguments.length?r([n[0],n[1],n.length>2?n[2]+90:90]):(n=r(),[n[0],n[1],n[2]-90])},r([0,0,90]).scale(159.155)};n.geoArea=hr,n.geoBounds=dr,n.geoCentroid=yr,n.geoCircle=br,n.geoClipExtent=Ir,n.geoContains=Vr,n.geoDistance=Jr,n.geoGraticule=sn,n.geoGraticule10=pn,n.geoInterpolate=Wr,n.geoLength=Yr,n.geoPath=wi,n.geoAlbers=Oi,n.geoAlbersUsa=Gi,n.geoAzimuthalEqualArea=ki,n.geoAzimuthalEqualAreaRaw=Ti,n.geoAzimuthalEquidistant=Ii,n.geoAzimuthalEquidistantRaw=Fi,n.geoConicConformal=Di,n.geoConicConformalRaw=nt,n.geoConicEqualArea=Li,n.geoConicEqualAreaRaw=Hn,n.geoConicEquidistant=Xi,n.geoConicEquidistantRaw=rt,n.geoEquirectangular=Ui,n.geoEquirectangularRaw=tt,n.geoGnomonic=Yi,n.geoGnomonicRaw=it,n.geoIdentity=Zi,n.geoProjection=Un,n.geoProjectionMutator=Xn,n.geoMercator=Bi,n.geoMercatorRaw=Vn,n.geoNaturalEarth1=Hi,n.geoNaturalEarth1Raw=ot,n.geoOrthographic=Ji,n.geoOrthographicRaw=ut,n.geoStereographic=Ki,n.geoStereographicRaw=at,n.geoTransverseMercator=Qi,n.geoTransverseMercatorRaw=ct,n.geoRotation=zr,n.geoStream=lr,n.geoTransform=Ci,Object.defineProperty(n,"__esModule",{value:!0})});

},{"d3-array":39}],41:[function(require,module,exports){
